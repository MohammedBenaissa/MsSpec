...
!======================================================================
!
MODULE CALC_TAU0J_RE
!
!  This module provides the subroutine to compute
!    Tau^{0 j} or Tau^{j 0} in the renormalized series expansion
!
      USE ACCURACY_REAL
      USE DIMENSION_CODE
!
...
!======================================================================
!
      SUBROUTINE CALC_TAU_RE(TAU_TYPE,IATL,JE,TAU)
!
...
!
!  Starting from last two atoms M and I in the input path, it will
...
!     JPOS     : position of last atom generated in the path (atom J or atom K)
...
!  Case MU1 = 0
!
            LAMBDA1 = LBD(0,NU1)   +2                        !!   !!!!! +2 added                                 !
!
!    Case MU2 = 0
!
            LAMBDA2 = LBD(0,NU2)      +2                        !!   !!!!! +2 added                              !
            LMIN = MAX(NU1,NU2)                                     !
            SL = ZEROC                                              !
            DO L = LMIN, LMJ                                        !
              IF(NEQUAL == 1) THEN                                  !
...
!
            ...
            SIG2  = ONE                                             !
            DO MU2 = 1, MUMAX2                                      !
              LAMBDA2_1 = LBD(MU2,NU2)  +2                        !!   !!!!! +2 added                            !
              LAMBDA2_2 = LBD(-MU2,NU2)  +2                        !!   !!!!! +2 added                           !
              PROD2     = PROD2 * EXP2                              !
              SIG2      = - SIG2                                    !
...
!
            ...
            SIG1  = ONE                                             !
            DO MU1 = 1, MUMAX1                                      !
              LAMBDA1_1 = LBD(MU1,NU1)  +2                        !!   !!!!! +2 added                            !
              LAMBDA1_2 = LBD(-MU1,NU1) +2                        !!   !!!!! +2 added                            !
              PROD1     = PROD1 * EXP1                              !
              SIG1      = - SIG1                                    !
!
!    Case MU2 = 0
...
!
!  This version makes use of the renormalization of the MS series
!
!
!   Author :  D. Sébilleau
!
